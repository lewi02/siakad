    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Cetak Absen</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="index.php"><i class="fa fa-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Cetak Absen</li>
                </ol>
            </div>
            <div class="page-content fade-in-up">
               <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Cetak Absen</div>
                       
                    </div>
                    <div class="ibox-body">
                        <div class="alert alert-primary" role="alert">
                          Silahkan Memilih Jadwal Pelajaran untuk mencetak Absensi
                        </div>
                        <table class="table table-striped table-bordered table-hover" id="listdata" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><a href="Laporan/blangkoabsen.php?id=<?php echo  $row['id_jadwal'];?>&id_kelas=<?php echo  $row['id_kelas'];?>" class="btn btn-primary btn-mini" target="_blank" title="Cetak Blangko Absen"><i class="fa fa-id-card"></i></a> <a href="Laporan/absensiswa.php?id=<?php echo  $row['id_jadwal'];?>&id_kelas=<?php echo  $row['id_kelas'];?>" class="btn btn-danger btn-mini" target="_blank" title="Cetak Absen Siswa"><i class="fa fa-barcode"></i></a></td>
                              </tr>
                             <?php } ?>
                            </tbody>
